...
<div class="row rowFull">
	<div class="small-12 small-centered columns cover-photo" style="background:url('<?php echo $loggedInUser->coverPhoto; ?>');">
...
<?php } ?>
	...
	<!-- Tile -->
			...
			<!-- Tile -->
		<span class="tile wide sky" data-href="nutrition">
		<span class="delete">
		&times;</span>
		<span class="edit">
		...
		<span class="tileIcon fa fa-calculator"> </span>
		<span class="tileTitle">My Nutrition</span></span>

			<!-- Tile -->
		<span class="tile wide red" data-href="history">
		<span class="delete">
		&times;</span>
		<span class="edit">
		<span class="fa fa-pencil">
		...
		<span class="tileIcon fa fa-calendar"> </span>
		<span class="tileTitle">History</span></span>

		<!-- Tile -->
		<span class="tile wide orange" data-href="settings">
		<span class="delete">
		&times;</span>
		<span class="edit">
		<span class="fa fa-pencil">
		...
		<span class="tileTitle">My Activities</span></span>-->
			...
			<!-- Tile -->
		<span class="tile wide success" data-href="research">
		<span class="delete">
		&times;</span>
		<span class="edit">
		<span class="fa fa-pencil">
		...
		<span class="tileIcon fa fa-search"> </span>
		...
		<?php if($loggedInUser->accountType == 'coach'){
			?>
<span class="tile sky" data-href="settings">
		<span class="delete">
		&times;</span>
		<span class="edit">
		<span class="fa fa-pencil">
		...
		<span class="tileIcon fa fa-th"> </span>
